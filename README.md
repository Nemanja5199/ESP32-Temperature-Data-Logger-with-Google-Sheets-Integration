...
2. **Google Sheets Setup:**
   ...
   - Enable the Google Sheets API and generate credentials (OAuth 2.0 client ID) following [these instructions](https://randomnerdtutorials.com/esp32-datalogging-google-sheets/).
